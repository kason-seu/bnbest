...
class K15Strategy:
    ...
    def handle(self):
        ...
        if (open_price > close_price) and (lower_ratio < -0.03):
            logger.info(
        ...
        if (open_price < close_price) and (upper_ratio > 0.03):
            logger.info(
        ...
        if (open_price > close_price) and (lower_ratio < -0.011):
            logger.info(
        ...
        if (open_price < close_price) and (upper_ratio > 0.011):
            logger.info(
