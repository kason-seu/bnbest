...
if __name__ == '__main__':  # Entry point when running this script
    ...
    store = binance_store.create_store(testnet=False, coin_target=coin_target)
    ...
    data = store.getdata(timeframe=bt.TimeFrame.Days, compression=1, dataname=symbol, start_date=from_date,
                         LiveBars=False)
